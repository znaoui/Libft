...
SRCS = $(addprefix ./, ft_memmove.c ft_memcmp.c ft_striteri.c ft_strmapi.c ft_memchr.c ft_putendl_fd.c ft_putstr_fd.c ft_putchar_fd.c \
...
BONUS = $(addprefix ./, ft_lstlast.c ft_lstiter.c ft_lstclear.c ft_lstdelone.c ft_lstadd_back.c ft_lstsize.c ft_lstadd_front.c \
